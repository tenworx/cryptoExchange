...
class CoinDetailsState extends State<CoinDetails>
  ...
  _makeTabs() {
    if (widget.enableTransactions) {
      ...
      _tabAmt = 2;
      _tabBarChildren = [
        new Tab(text: "View Stats"),
        new Tab(text: "View Markets")
      ];
    }
  }
        ...
        children: <Widget>[
          new Container(
            padding: const EdgeInsets.only(
                left: 10.0, right: 9.0, top: 10.0, bottom: 4.0),
            child: new Row(
                  ...
                  itemBuilder: (BuildContext context) {
                    ...
                    for (int i = 0;
                      ...
                      options.add(new PopupMenuItem(
                          child:
                              new Text(ohlcvWidthOptions[historyTotal][i][0]),
                          value: i));
                    }
                    return options;
                  },
                ...
                new Container(
                  ...
                  itemBuilder: (BuildContext context) => [
                    ...
                    new PopupMenuItem(
                        ...
                        value: ["hour", "720", "1M", "1"]),
                    new PopupMenuItem(
                        child: new Text("3M"), value: ["day", "90", "3M", "1"]),
                    new PopupMenuItem(
                        child: new Text("6M"),
                        value: ["day", "180", "6M", "1"]),
                    new PopupMenuItem(
          ...
          new Flexible(
            child: historyOHLCV != null
                ? new Container(
                    padding: EdgeInsets.only(left: 310, right: 10.0, top: 10.0),
                    child: historyOHLCV!.isEmpty != true
                        ? new OHLCVGraph(
                            ...
                            volumeProp: 0.2,
                            lineWidth: 1.0,
                            decreaseColor: Color.fromRGBO(229, 57, 53, 1),
                          )
                        : new Container(
