...
class CoinListItem extends StatelessWidget {
  ...
  _getImage() {
    if (assetImages.contains(snapshot["CoinInfo"]["Name"].toLowerCase())) {
      return new Image.asset(
          "assets/images/" +
              snapshot["CoinInfo"]["Name"].toLowerCase() +
              ".png",
          height: 28.0);
    } else {
  ...
  Widget build(BuildContext context) {
    if (!snapshot.containsKey("CoinInfo") ||
        !snapshot.containsKey("RAW") ||
        snapshot == null ||
        snapshot.isEmpty) {
      return new Container();
    }
            ...
            children: <Widget>[
              ...
              new Container(
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      new Text(
                          "\$" + normalizeNum(snapshot["RAW"]["USD"]["MKTCAP"]),
                          style: Theme.of(context).textTheme.bodyText2),
              ...
              new Container(
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    new Text("\$" +
                        normalizeNumNoCommas(snapshot["RAW"]["USD"]["PRICE"])),
                    new Padding(padding: const EdgeInsets.only(bottom: 4.0)),
                    new Text(
