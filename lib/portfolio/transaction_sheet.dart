...
class TransactionSheetState extends State<TransactionSheet> {
  ...
  Widget build(BuildContext context) {
    validColor = Theme.of(context).textTheme.bodyText2!.color;
    return new Container(
        ...
        padding: const EdgeInsets.only(
            top: 8.0, bottom: 8.0, right: 10.0, left: 16.0),
        child: new Row(
...
//                      child: new Text(widget.editMode ? "Edit Transaction" : "Add Transaction", style: Theme.of(context).textTheme.bodyText2.apply(fontSizeFactor: 1.2, fontWeightDelta: 2))
//                    ),
                    new Row(
                      children: <Widget>[
                        new Text("Buy",
