...
class TabsState extends State<Tabs> with SingleTickerProviderStateMixin {
  ...
  _openTransaction() {
    ...
    _scaffoldKey.currentState!
        ...
        .whenComplete(() {
          ...
          //   sheetOpen = false;
          // });
          controller.sheetOpen.value = false;
        });
  }
            ...
            child: new Scaffold(
                ...
                body: new ListView(
                  children: <Widget>[
                    SizedBox(height: 24),
                    new ListTile(
                      title: new Text("Welcome To DIGAC",
                          style: TextStyle(fontSize: 17)),
                    ),
                    // SizedBox(height:34),
                    // new ListTile(
                    //   leading: new Icon(Icons.person),
                    //   title: new Text(loggedinUser.email ?? "Guest",style:TextStyle(fontSize:15)),
                    //     ),
                    new ListTile(
  ...
  Widget _transactionFAB(BuildContext context) {
    return controller.sheetOpen.value
        ...
        ? new RefreshIndicator(
            ...
            child: new CustomScrollView(
              slivers: <Widget>[
                SliverList(
                    delegate: new SliverChildListDelegate(<Widget>[
                  globalData != null && controller.isSearching.value != true
                      ? new Container(
